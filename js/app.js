 ...
 */
    ...
    (() => {
        ...
        window.addEventListener("load", (function(e) {
            ...
            if (cottagesSliders.length) cottagesSliders.forEach((slider => {
                new Swiper(slider, {
        ...
        locationMap.addEventListener("click", (e => {
            window.open("https://www.openstreetmap.org/?mlat=51.06116&mlon=71.43724#map=13/51.067936/71.42287");
        }));
        ...
        contactsMap.addEventListener("click", (e => {
            window.open("https://www.openstreetmap.org/?mlat=51.13057&mlon=71.42255#map=16/51.12974/71.42203");
        }));
        ...
        let goTopObserver = new IntersectionObserver((entries => {
            ...
            if (!goTopBtn) return;
            if (entries[0].isIntersecting) goTopBtn.classList.add("_hide"); else goTopBtn.classList.remove("_hide");
        }), {});
